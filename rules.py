...
# perguntar ao usuario
    ...
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_de_cabeca=W())), salience=5)
    def sintoma_0(self):
        self.declare(Fact(dor_de_cabeca=input("dor de cabeça: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(febre=W())), salience=1)
    def sintoma_1(self):
        self.declare(Fact(febre=input("febre: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(tontura=W())), salience=1)
    def sintoma_2(self):
        self.declare(Fact(tontura=input("tontura: ")))    
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_olho=W())), salience=3)
    def sintoma_3(self):
        self.declare(Fact(dor_olho=input("dor no olho: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(perda_paladar_apetite=W())), salience=1)
    def sintoma_4(self):
        self.declare(Fact(perda_paladar_apetite=input("perda no paladar e no apetite: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(manchas_erupcoes=W())), salience=1)
    def sintoma_5(self):
        self.declare(Fact(manchas_erupcoes=input("manchas e erupçoes na pele: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(cansaco=W())), salience=1)
    def sintoma_6(self):
        self.declare(Fact(cansaco=input("cansaço: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_corpo=W())), salience=1)
    def sintoma_7(self):
        self.declare(Fact(dor_corpo=input("dor no corpo: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_osso_articulacao=W())), salience=1)
    def sintoma_8(self):
        self.declare(Fact(dor_osso_articulacao=input("dor nos ossos e nas articulações: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_abdominal=W())), salience=1)
    def sintoma_9(self):
        self.declare(Fact(dor_abdominal=input("dor abdominal: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(nausea_vomito=W())), salience=1)
    def sintoma_10(self):
        self.declare(Fact(nausea_vomito=input("nausea e vomito: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(tosse=W())), salience=1)
    def sintoma_11(self):
        self.declare(Fact(tosse=input("tosse: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(calafrio=W())), salience=1)
    def sintoma_12(self):
        self.declare(Fact(calafrio=input("calafrio: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(suores=W())), salience=1)
    def sintoma_13(self):
        self.declare(Fact(suores=input("suores: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(fraqueza=W())), salience=1)
    def sintoma_14(self):
        self.declare(Fact(fraqueza=input("fraqueza: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(diarreia=W())), salience=1)
    def sintoma_15(self):
        self.declare(Fact(diarreia=input("diarreia: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(coceira_anal=W())), salience=1)
    def sintoma_16(self):
        self.declare(Fact(coceira_anal=input("coceira_anal: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(palpitacao=W())), salience=1)
    def sintoma_17(self):
        self.declare(Fact(palpitacao=input("palpitação: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(impotencia=W())), salience=1)
    def sintoma_18(self):
        self.declare(Fact(impotencia=input("impotencia: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(emagrecimento=W())), salience=1)
    def sintoma_19(self):
        self.declare(Fact(emagrecimento=input("emagrecimento: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(end_aum_figado=W())), salience=1)
    def sintoma_20(self):
        self.declare(Fact(end_aum_figado=input("endurecimento ou aumento do figado: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_muscular=W())), salience=1)
    def sintoma_21(self):
        self.declare(Fact(dor_muscular=input("dor muscular: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(sens_plen_gastr=W())), salience=1)
    def sintoma_22(self):
        self.declare(Fact(sens_plen_gastr=input("sensação de plenitude gastrica: ")))

    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_costas=W())), salience=1)
    def sintoma_23(self):
        self.declare(Fact(dor_costas=input("dores nas costas: ")))
    
    @Rule(Fact(action="procurar_doenca"), NOT(Fact(dor_articulacao=W())), salience=1)
    def sintoma_24(self):
